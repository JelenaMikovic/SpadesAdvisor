...
('Uncle Sams Diner', 3, 'Bulevar Jovana Dučića 7, Detelinara, Novi Sad', 2200.00, '08:00', '20:00', true, true),
('Le Petit Bistro', 4, 'Futoška 44, Grbavica, Novi Sad', 2700.00, '18:00', '00:00', false, false),
('Sakura Sushi', 5, 'Narodnog Fronta 20, Liman, Novi Sad', 3000.00, '12:00', '22:00', true, false),
('Taj Mahal', 6, 'Bulevar Evrope 15, Novo Naselje, Novi Sad', 2300.00, '12:30', '22:30', true, false),
('Bangkok Spice', 7, 'Bulevar Despota Stefana 11, Detelinara, Novi Sad', 2500.00, '12:00', '21:00', true, false),
('Olive Tree Taverna', 8, 'Fruškogorska 2, Telep, Novi Sad', 2700.00, '17:30', '23:00', true, false),
('Balkan Grill', 9, 'Bulevar Cara Lazara 33, Liman, Novi Sad', 2000.00, '11:00', '22:00', true, true),
...
('Route 66 Diner', 3, 'Bulevar Jovana Dučića 9, Detelinara, Novi Sad', 2200.00, '08:00', '21:00', true, true),
('Le Croissant', 4, 'Njegoševa 6, Stari Grad, Novi Sad', 2700.00, '07:00', '20:00', false, false),
('Mumbai Delight', 6, 'Jovana Subotića 10, Adamovićevo Naselje, Novi Sad', 2300.00, '12:30', '22:30', true, false),
('Thai Orchid', 7, 'Bulevar Oslobođenja 15, Telep, Novi Sad', 2500.00, '12:00', '21:00', true, false),
('Athenas Tavern', 8, 'Fruškogorska 8, Liman, Novi Sad', 2700.00, '17:00', '23:00', true, false),
('Balkan Delight', 9, 'Bulevar Mihajla Pupina 22, Novo Naselje, Novi Sad', 2000.00, '11:00', '22:00', true, true),
('Pasta Paradise', 0, 'Bulevar Cara Lazara 7, Liman, Novi Sad', 2800.00, '18:00', '22:30', true, false),
('Peking Palace', 1, 'Narodnog Fronta 18, Detelinara, Novi Sad', 2000.00, '11:00', '21:30', true, false),
('El Paso', 2, 'Futoška 28, Adamovićevo Naselje, Novi Sad', 1800.00, '12:00', '22:00', true, true),
('Star Spangled Diner', 3, 'Bulevar Jovana Dučića 11, Detelinara, Novi Sad', 2200.00, '08:00', '21:00', true, true),
('Le Bistro', 4, 'Njegoševa 12, Stari Grad, Novi Sad', 2700.00, '18:00', '23:00', false, false),
('Tokyo Teppanyaki', 5, 'Bulevar Oslobođenja 17, Liman 2, Novi Sad', 3000.00, '12:00', '22:00', true, false),
('Taj Palace', 6, 'Jovana Subotića 18, Telep, Novi Sad', 2300.00, '12:30', '22:30', true, false),
('Siam Spice', 7, 'Bulevar Despota Stefana 19, Detelinara, Novi Sad', 2500.00, '12:00', '21:00', true, false),
('Olive Grove', 8, 'Fruškogorska 20, Telep, Novi Sad', 2700.00, '17:30', '23:00', true, false),
('Balkan Feast', 9, 'Bulevar Cara Lazara 31, Liman, Novi Sad', 2000.00, '11:00', '22:00', true, true),
('Pizza Roma', 0, 'Bulevar Mihajla Pupina 25, Novo Naselje, Novi Sad', 1800.00, '11:00', '23:00', true, false),
('Chopsticks', 1, 'Narodnog Fronta 8, Liman, Novi Sad', 2000.00, '11:30', '22:30', true, false),
('El Burrito', 2, 'Bulevar Evrope 10, Novo Naselje, Novi Sad', 1900.00, '11:00', '22:00', true, true),
('Stars and Stripes', 3, 'Bulevar Jovana Dučića 15, Detelinara, Novi Sad', 2200.00, '08:00', '21:00', true, true),
('Le Salon', 4, 'Futoška 16, Grbavica, Novi Sad', 2600.00, '18:00', '23:00', false, false),
('Sushi Ninja', 5, 'Bulevar Oslobođenja 12, Telep, Novi Sad', 2900.00, '12:00', '22:00', true, false),
...
('Olive Branch', 8, 'Fruškogorska 25, Telep, Novi Sad', 2600.00, '17:30', '23:00', true, false),
('Balkan Grillhouse', 9, 'Bulevar Cara Lazara 37, Liman 2, Novi Sad', 2100.00, '11:00', '22:00', true, true),
('Serbian Grillhouse', 9, 'Bulevar Oslobođenja 3, Stari Grad, Novi Sad', 1800.00, '11:00', '22:00', true, true);
